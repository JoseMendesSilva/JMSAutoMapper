// dotnet pack --configuration Release --output D:\nupkgs -p:JMSAutoMapper=1.0.13 -p:Authors="José Mendes da Silva" -p:Description="Biblioteca para mapeamento de objeto-objeto para .NET"

/* -------------------Arquivo de Backup (Este funciona corretamente) -------------------*/
...
namespace JMSAutoMapper
{
    ...
    /// var listaDestino = mapper.MapList&lt;Destino&gt;(listaOrigem);
    /// </code>
    /// </remarks>
    public interface IMapper
    {
        ...
        /// <typeparam name="T">Tipo dos elementos da coleção destino.</typeparam>
        /// <param name="source">Coleção de origem.</param>
        /// <returns>ICollection com os elementos mapeados.</returns>
        ICollection<T> MapICollection<T>(object? source);

        /// <summary>Mapeia para IReadOnlyList.</summary>
        /// <typeparam name="T">Tipo dos elementos da lista destino.</typeparam>
        /// <param name="source">Coleção de origem.</param>
        /// <returns>IReadOnlyList com os elementos mapeados.</returns>
        IReadOnlyList<T> MapIReadOnlyList<T>(object? source);

        /// <summary>Mapeia para IReadOnlyCollection.</summary>
        /// <typeparam name="T">Tipo dos elementos da coleção destino.</typeparam>
        /// <param name="source">Coleção de origem.</param>
        /// <returns>IReadOnlyCollection com os elementos mapeados.</returns>
        IReadOnlyCollection<T> MapIReadOnlyCollection<T>(object? source);

        /// <summary>Mapeia para array.</summary>
        /// <typeparam name="T">Tipo dos elementos do array destino.</typeparam>
        /// <param name="source">Coleção de origem.</param>
        /// <returns>Array com os elementos mapeados.</returns>
        T[] MapArray<T>(object? source);

        /// <summary>Mapeia para HashSet.</summary>
        /// <typeparam name="T">Tipo dos elementos do HashSet destino.</typeparam>
        /// <param name="source">Coleção de origem.</param>
        /// <returns>HashSet com os elementos mapeados.</returns>
        ...
        /// <param name="source">Dicionário de origem.</param>
        /// <returns>Dictionary com os pares chave-valor mapeados.</returns>
        Dictionary<TKey, TValue> MapDictionary<TKey, TValue>(object? source) where TKey : notnull;

        /// <summary>Mapeia para ImmutableList.</summary>
        /// <typeparam name="T">Tipo dos elementos da lista destino.</typeparam>
        /// <param name="source">Coleção de origem.</param>
        /// <returns>ImmutableList com os elementos mapeados.</returns>
        ...
        /// <typeparam name="TValue">Tipo do valor.</typeparam>
        /// <param name="source">Dicionário de origem.</param>
        /// <returns>ImmutableDictionary com os pares chave-valor mapeados.</returns>
        ImmutableDictionary<TKey, TValue> MapImmutableDictionary<TKey, TValue>(object? source) where TKey : notnull;

        /// <summary>Mapeia para ImmutableArray.</summary>
        /// <typeparam name="T">Tipo dos elementos do array destino.</typeparam>
        /// <param name="source">Coleção de origem.</param>
        /// <returns>ImmutableArray com os elementos mapeados.</returns>
        ImmutableArray<T> MapImmutableArray<T>(object? source);

        /// <summary>Mapeia para ImmutableQueue.</summary>
        /// <typeparam name="T">Tipo dos elementos da fila destino.</typeparam>
        /// <param name="source">Coleção de origem.</param>
        /// <returns>ImmutableQueue com os elementos mapeados.</returns>
        ImmutableQueue<T> MapImmutableQueue<T>(object? source);

        /// <summary>Mapeia para ImmutableStack.</summary>
        /// <typeparam name="T">Tipo dos elementos da pilha destino.</typeparam>
        /// <param name="source">Coleção de origem.</param>
        /// <returns>ImmutableStack com os elementos mapeados.</returns>
    ...
    public class ResolutionContext
    {
        ...
        public async Task<TDestination> MapAsync<TSource, TDestination>(TSource source, CancellationToken cancellationToken = default)
        {
            ...
            var mapper = _configuration.CreateMapper();
            var task = mapper.MapAsync<TSource, TDestination>(source, cancellationToken);
    ...
    public class MemberConfigurationExpression<TSource, TDestination, TMember> : IMemberConfigurationExpression<TSource, TDestination, TMember>
    {
        ...
        public void MapFrom(IValueResolver<TSource, TDestination, TMember> resolver)
        {
            ...
            mappings[_propertyName] = src =>
            {
                ...
                var context = new ResolutionContext(_config);
        ...
        public void NullSubstitute(object value)
        {
            ...
            mappings[_propertyName] = src =>
            {
                var result = originalMapping?.Invoke(src);
                return result ?? value;
            };
        }
        ...
        public void ConvertUsing(Func<TMember, object> converter)
        {
            ...
            mappings[_propertyName] = src =>
            {
                var value = originalMapping?.Invoke(src);
    ...
    public abstract class MapperBase : IMapper
    {
        ...
        public virtual T Map<T>(object? source)
        {
            ...
            try
            {
                // Adicione esta verificação no início do seu método Map<T>
                if (typeof(T).IsGenericType && typeof(T).GetGenericTypeDefinition() == typeof(IEnumerable<>))
                {
                    var elementType = typeof(T).GetGenericArguments()[0];
                    var method = typeof(JMSMapper).GetMethod(nameof(MapIEnumerable))
                ...
                {
                    var elementType = typeof(T).GetGenericArguments()[0];
                    var method = typeof(JMSMapper).GetMethod(nameof(MapList))
                                  ?.MakeGenericMethod(elementType);
                    return (T)method?.Invoke(this, new[] { source })!;
                }
        ...
        /// <inheritdoc/>
        public IEnumerable<T> MapIEnumerable<T>(object? source)
        {
        ...
        /// <inheritdoc/>
        public ICollection<T> MapICollection<T>(object? source) => MapIEnumerable<T>(source).ToList();

        /// <inheritdoc/>
        public IReadOnlyList<T> MapIReadOnlyList<T>(object? source) => MapIEnumerable<T>(source).ToList();

        /// <inheritdoc/>
        public IReadOnlyCollection<T> MapIReadOnlyCollection<T>(object? source) => MapIEnumerable<T>(source).ToList();

        /// <inheritdoc/>
        public T[] MapArray<T>(object? source) => MapIEnumerable<T>(source).ToArray();

        /// <inheritdoc/>
        public HashSet<T> MapHashSet<T>(object? source) => new HashSet<T>(MapIEnumerable<T>(source));

        /// <inheritdoc/>
        public Dictionary<TKey, TValue> MapDictionary<TKey, TValue>(object? source) where TKey : notnull
        {
        ...
        /// <inheritdoc/>
        public ImmutableList<T> MapImmutableList<T>(object? source) => MapIEnumerable<T>(source).ToImmutableList();

        /// <inheritdoc/>
        public ImmutableDictionary<TKey, TValue> MapImmutableDictionary<TKey, TValue>(object? source) where TKey : notnull
            => MapDictionary<TKey, TValue>(source).ToImmutableDictionary();

        /// <inheritdoc/>
        public ImmutableArray<T> MapImmutableArray<T>(object? source) => MapIEnumerable<T>(source).ToImmutableArray();

        /// <inheritdoc/>
        public ImmutableQueue<T> MapImmutableQueue<T>(object? source) => ImmutableQueue.CreateRange(MapIEnumerable<T>(source));

        /// <inheritdoc/>
        public ImmutableStack<T> MapImmutableStack<T>(object? source) => ImmutableStack.CreateRange(MapIEnumerable<T>(source));
    ...
    public class JMSMapper : MapperBase
    {
        ...
        protected override async Task<T> MapObjectAsync<T>(object source, ConcurrentDictionary<object, object> mappedObjects, CancellationToken cancellationToken)
        {
            ...
            if (_config.AsyncCustomMappings.TryGetValue(key, out var asyncMappings) && asyncMappings.Any())
            {
                var result = await MapObjectWithAsyncResolvers<T>(source, asyncMappings, cancellationToken).ConfigureAwait(false);
                mappedObjects[source] = result!;
                return result;
            }

            return MapObject<T>(source, new Dictionary<object, object>(mappedObjects));
        }

        private async Task<T> MapObjectWithAsyncResolvers<T>(object source, ConcurrentDictionary<string, Func<object, CancellationToken, Task<object>>> asyncMappings, CancellationToken cancellationToken)
        {
            var targetType = typeof(T);
            var result = (T)Activator.CreateInstance(targetType)!;
            var sourceType = source.GetType();
            ...
            foreach (var targetProperty in targetProperties)
            {
                ...
                if (_config.IgnoredProperties.ContainsKey((sourceType, targetType, targetProperty.Name))) continue;

                if (asyncMappings.TryGetValue(targetProperty.Name, out var asyncMapping))
                {
                    var value = await asyncMapping(source, cancellationToken).ConfigureAwait(false);
                    var converted = ConvertValue(value, targetProperty.PropertyType);
                    targetProperty.SetValue(result, converted);
                }
                else
                {
        ...
        {
            if (source == null) return destination;
            if (mappedObjects.TryGetValue(source!, out var existing)) return (TDestination)existing;
        ...
        private Delegate BuildMapperDelegate(Type sourceType, Type targetType)
        {
            ...
            foreach (var targetProperty in targetProperties.Where(p => p.CanWrite))
            {
                ...
                {
                    var valueExpression = Expression.Invoke(
                        Expression.Constant(mappingFunc),
                        Expression.Convert(sourceVar, typeof(object)));
                ...
                {
                    var sourcePropertyName = GetMappedPropertyName(
                        sourceType, targetType, targetProperty.Name, _config.PropertyMappings);
                    ...
                    if (IsCollection(targetProperty.PropertyType))
                    {
                        ...
                        assignment = Expression.Assign(
                            Expression.Property(resultVar, targetProperty),
                            Expression.Convert(mapCollectionHelperCall, targetProperty.PropertyType));
                    }
                    else if (IsComplexType(targetProperty.PropertyType) && !IsSimpleType(targetProperty.PropertyType))
                    {
                        // Usar delegate cacheado em vez de reflexão direta
                        var mapObjectCall = Expression.Invoke(
                            mapComplexTypeConstant,
                            Expression.Convert(sourcePropertyAccess, typeof(object)),
                            mappedObjectsParam);

                        assignment = Expression.Assign(
                            Expression.Property(resultVar, targetProperty),
                            Expression.Convert(mapObjectCall, targetProperty.PropertyType));
                    }
                    else
                    {
                        ...
                        assignment = Expression.Assign(
                            Expression.Property(resultVar, targetProperty),
                            Expression.Convert(convertedValue, targetProperty.PropertyType));
                    }
        ...
        {
            if (source == null) return null;
            if (mappedObjects.TryGetValue(source, out var existing)) return existing;
        ...
        private class ProjectionExpressionVisitor : ExpressionVisitor
        {
            ...
            public Expression Visit()
            {
                ...
                foreach (var targetProperty in targetProperties)
                {
                    ...
                    {
                        var sourcePropertyAccess = Expression.Property(_sourceExpression, sourceProperty);
...
// =============================================================================
// JMSAutoMapper.cs - VERSÃO CORRIGIDA COM SUPORTE A double/decimal E OTIMIZADA COM CACHE CORRIGIDO
// =============================================================================
// 
// JMSAutoMapper é uma biblioteca de mapeamento objeto-objeto de alto desempenho
// para .NET, inspirada no AutoMapper, mas com funcionalidades avançadas como
// cache distribuído, validação de configuração, suporte assíncrono e muito mais.
// 
// PRINCIPAIS CARACTERÍSTICAS:
// - Mapeamento por convenção (nomes iguais ou com naming convention)
// - Mapeamento customizado via expressões lambda ou value resolvers
// - Suporte síncrono e assíncrono (IAsyncValueResolver)
// - Mapeamento de coleções (List, Array, Dictionary, Immutable collections)
// - Projeções LINQ (ProjectTo, MapQueryable)
// - Cache de expressões compiladas (ExpressionPool)
// - Cache distribuído com suporte a cache estático e por objeto
// - Cache inteligente com chaves consistentes
// - Validação de configuração (ConfigurationValidator)
// - Diagnóstico e métricas de performance
// - Integração com DI via Microsoft.Extensions.DependencyInjection
// - Suporte a perfis (Profile) e assembly scanning
// 
// GUIA RÁPIDO DE USO E CONFIGURAÇÃO:
// 
// 1. CONFIGURAÇÃO BÁSICA
// var config = new MapperConfiguration();
// config.CreateMap<Usuario, UsuarioDto>()
//     .ForMember(dto => dto.NomeCompleto, src => src.Nome + " " + src.Sobrenome)
//     .ForMember(dto => dto.Idade, "IdadeUsuario") // Mapeamento por nome de propriedade diferente
//     .ReverseMap(); // Mapeamento bidirecional automático
// 
// 2. USO DE PERFIS (Recomendado para organização)
// public class UsuarioProfile : Profile 
// {
//     public override void Configure() 
//     {
//         CreateMap<Usuario, UsuarioDto>()
//             .Ignore(dest => dest.Senha) // Ignorar propriedade
//             .Condition(src => src.Ativo); // Mapear apenas se Ativo for true
//     }
// }
// config.AddProfile<UsuarioProfile>();
//
// 3. USO DA INSTÂNCIA (IMapper)
// var mapper = config.CreateMapper();
// var dto = mapper.Map<UsuarioDto>(usuario);
// var listaDto = mapper.MapList<UsuarioDto>(listaUsuarios); // Mapeamento de listas otimizado
// var arrayDto = mapper.MapArray<UsuarioDto>(arrayUsuarios);
// 
// 4. MAPEAMENTO ASSÍNCRONO
// var dto = await mapper.MapAsync<UsuarioDto>(usuario, cancellationToken);
// 
// 5. PROJEÇÕES (IQueryable / Entity Framework)
// var queryDto = mapper.MapQueryable<Usuario, UsuarioDto>(dbContext.Usuarios);
// 
// 6. INTEGRAÇÃO COM DI (Program.cs)
...
//     options.MaxDepth = 10;
//     options.ValidateOnBuild = true; // Valida configuração na inicialização
// });
// 
// =============================================================================

//// dotnet pack --configuration Release --output D:\NuGetLocal\DeployParaTeste -p:JMSAutoMapper=1.0.12 -p:Authors="José Mendes da Silva" -p:Description="Biblioteca para mapeamento de objeto-objeto para .NET"
...
//    {
//        private readonly MapperConfiguration _configuration;
//        private readonly Dictionary<object, object> _instanceCache = new();
...
//        public static void AssertConfigurationIsValid(this MapperConfiguration config, Func<IEnumerable<string>, bool>? shouldSkipWarning = null)
//        {
//            ConfigurationValidator.Validate(config);
//            config.AssertConfigurationIsValidInternal();
//        }
//    }
...
//    {
//        internal MapperConfiguration Configuration { get; private set; }
//        public Profile() { Configuration = new MapperConfiguration(); Configure(); }
//        public virtual void Configure() { }
//        protected IMappingExpression<TSource, TDestination> CreateMap<TSource, TDestination>() => Configuration.CreateMap<TSource, TDestination>();
//    }
...
//        internal Dictionary<(Type Source, Type Target), Dictionary<string, LambdaExpression>> CustomMappingExpressions { get; } = new();
...
//        internal Dictionary<(Type Source, Type Target), List<Action<object, object>>> BeforeMapActions { get; } = new();
//        internal Dictionary<(Type Source, Type Target), List<Action<object, object>>> AfterMapActions { get; } = new();
//        internal Dictionary<(Type Source, Type Target), Func<object, object>> CustomConstructors { get; } = new();
//        internal Dictionary<Type, object> TypeConverters { get; } = new();
//        internal Dictionary<(Type Source, Type Target, string Property), object> ValueResolvers { get; } = new();
...
//        {
//            var profile = new TProfile();
//            foreach (var customMapping in profile.Configuration.CustomMappings) CustomMappings[customMapping.Key] = customMapping.Value;
//            foreach (var customMappingExpression in profile.Configuration.CustomMappingExpressions) CustomMappingExpressions[customMappingExpression.Key] = customMappingExpression.Value;
//            foreach (var propertyMapping in profile.Configuration.PropertyMappings) PropertyMappings[propertyMapping.Key] = propertyMapping.Value;
//            foreach (var conditionalMapping in profile.Configuration.ConditionalMappings) ConditionalMappings[conditionalMapping.Key] = conditionalMapping.Value;
//            foreach (var ignoredProperty in profile.Configuration.IgnoredProperties) IgnoredProperties.Add(ignoredProperty);
//            foreach (var constructor in profile.Configuration.ConstructorSelection) ConstructorSelection[constructor.Key] = constructor.Value;
//            foreach (var beforeMap in profile.Configuration.BeforeMapActions) BeforeMapActions[beforeMap.Key] = beforeMap.Value;
//            foreach (var afterMap in profile.Configuration.AfterMapActions) AfterMapActions[afterMap.Key] = afterMap.Value;
//            foreach (var customConstructor in profile.Configuration.CustomConstructors) CustomConstructors[customConstructor.Key] = customConstructor.Value;
//            foreach (var typeConverter in profile.Configuration.TypeConverters) TypeConverters[typeConverter.Key] = typeConverter.Value;
//            foreach (var valueResolver in profile.Configuration.ValueResolvers) ValueResolvers[valueResolver.Key] = valueResolver.Value;
//        }
...
//            foreach (var typeMap in CustomMappings.Keys.Concat(PropertyMappings.Keys).Distinct())
//            {
//                var sourceType = typeMap.Source;
//                var targetType = typeMap.Target;
//                var targetProperties = targetType.GetProperties(BindingFlags.Public | BindingFlags.Instance).Where(p => p.CanWrite);
//                var mappedProperties = new HashSet<string>();

//                if (CustomMappings.TryGetValue(typeMap, out var customMaps)) mappedProperties.UnionWith(customMaps.Keys);
//                if (PropertyMappings.TryGetValue(typeMap, out var propMaps)) mappedProperties.UnionWith(propMaps.Keys);
//                if (IgnoredProperties.Any(ip => ip.Source == sourceType && ip.Target == targetType)) mappedProperties.UnionWith(IgnoredProperties.Where(ip => ip.Source == sourceType && ip.Target == targetType).Select(ip => ip.PropertyName));

//                var unmapped = targetProperties.Where(p => !mappedProperties.Contains(p.Name)).Select(p => $"{sourceType.Name} -> {targetType.Name}: {p.Name}");
//                unmappedProperties.AddRange(unmapped);
//            }

//            if (unmappedProperties.Any() && ValidateMemberList == MemberListType.Destination)
//            {
//                throw new MappingException("Unmapped properties found:\n" + string.Join("\n", unmappedProperties));
//            }
//        }
...
//    {
//        private readonly MapperConfiguration _config;
//        private MemberListType _memberListType = MemberListType.Destination;
...
//            if (_config.PropertyMappings.TryGetValue(key, out var mappings))
//            {
//                foreach (var mapping in mappings) reverseMapping.ForMember(mapping.Value, mapping.Key);
//            }
...
//            _config.IgnoredProperties.Add((typeof(TSource), typeof(TDestination), memberExpression.Member.Name));
//            return this;
//        }
...
//        {
//            var key = (typeof(TSource), typeof(TDestination));
//            if (!_config.BeforeMapActions.TryGetValue(key, out var actions))
//            {
//                actions = new List<Action<object, object>>();
//                _config.BeforeMapActions[key] = actions;
//            }
//            actions.Add((src, dest) => beforeAction((TSource)src, (TDestination)dest));
//            return this;
//        }
...
//        {
//            var key = (typeof(TSource), typeof(TDestination));
//            if (!_config.AfterMapActions.TryGetValue(key, out var actions))
//            {
//                actions = new List<Action<object, object>>();
//                _config.AfterMapActions[key] = actions;
//            }
//            actions.Add((src, dest) => afterAction((TSource)src, (TDestination)dest));
//            return this;
//        }
...
//            if (_config.PropertyMappings.TryGetValue(baseKey, out var baseMappings))
//            {
//                if (!_config.PropertyMappings.TryGetValue(currentKey, out var currentMappings))
//                {
//                    currentMappings = new Dictionary<string, string>();
//                    _config.PropertyMappings[currentKey] = currentMappings;
//                }
//                foreach (var mapping in baseMappings.Where(m => !currentMappings.ContainsKey(m.Key)))
...
//            if (_config.CustomMappings.TryGetValue(baseKey, out var baseCustomMaps))
//            {
//                if (!_config.CustomMappings.TryGetValue(currentKey, out var currentCustomMaps))
//                {
//                    currentCustomMaps = new Dictionary<string, Func<object, object>>();
//                    _config.CustomMappings[currentKey] = currentCustomMaps;
//                }
//                foreach (var mapping in baseCustomMaps.Where(m => !currentCustomMaps.ContainsKey(m.Key)))
//                    currentCustomMaps.Add(mapping.Key, mapping.Value);
//            }
...
//        public void MapFrom(Expression<Func<TSource, TMember>> sourceMember)
//        {
//            if (!_config.CustomMappingExpressions.TryGetValue(_key, out var expressions))
//            {
//                expressions = new Dictionary<string, LambdaExpression>();
//                _config.CustomMappingExpressions[_key] = expressions;
//            }
//            expressions[_propertyName] = sourceMember;

//            var compiled = sourceMember.Compile();
//            if (!_config.CustomMappings.TryGetValue(_key, out var mappings))
//            {
//                mappings = new Dictionary<string, Func<object, object>>();
//                _config.CustomMappings[_key] = mappings;
//            }
//            mappings[_propertyName] = src => compiled((TSource)src);
//        }
...
//        // NOVA IMPLEMENTAÇÃO: Suporte a Value Resolvers
//        public void MapFrom<TResolver>() where TResolver : IValueResolver<TSource, TDestination, TMember>, new()
//        {
//            var resolver = new TResolver();
//            MapFrom(resolver);
...
//        public void Ignore() => _config.IgnoredProperties.Add((typeof(TSource), typeof(TDestination), _propertyName));

//        public void Condition(Func<TSource, bool> condition)
//        {
//            if (!_config.ConditionalMappings.TryGetValue(_key, out var conditions))
//            {
//                conditions = new Dictionary<string, Func<object, bool>>();
//                _config.ConditionalMappings[_key] = conditions;
//            }
//            conditions[_propertyName] = src => condition((TSource)src);
//        }
...
//                _config.CustomMappings[_key] = mappings;
//            }
//            var originalMapping = mappings.ContainsKey(_propertyName) ? mappings[_propertyName] : null;
//            mappings[_propertyName] = src =>
//            {
//                var result = originalMapping?.Invoke(src);
//                return result ?? value;
...
//        public void MapFromSourceMember(string sourceMemberName)
//        {
//            if (!_config.PropertyMappings.TryGetValue(_key, out var mappings))
//            {
//                mappings = new Dictionary<string, string>();
//                _config.PropertyMappings[_key] = mappings;
//            }
//            mappings[_propertyName] = sourceMemberName;
//        }
//    }
...
//                if (underlyingType.IsEnum) return ConvertToEnum(value, underlyingType);
//                if (value.GetType().IsEnum && underlyingType == typeof(string)) return value.ToString();
//                return Convert.ChangeType(value, underlyingType);
//            }
//            catch (Exception ex)
//            {
//                _logger?.Invoke($"Erro ao converter valor de '{value?.GetType().Name}' para '{targetType.Name}'", ex);
//                if (_config.ThrowOnConversionError) throw new MappingException($"Erro ao converter valor de '{value?.GetType().Name}' para '{targetType.Name}'", ex);
//                return null;
//            }
//        }
...
//            if (value.GetType().IsEnum) return Enum.ToObject(enumType, (int)value);
//            if (value is string stringValue) return Enum.Parse(enumType, stringValue, true);
//            if (value is int || value is short || value is byte || value is long || value is uint || value is ushort || value is sbyte || value is ulong) return Enum.ToObject(enumType, value);
//            if (value is decimal || value is double || value is float) return Enum.ToObject(enumType, Convert.ToInt32(value));
...
//        {
//            if (source == null) return Enumerable.Empty<T>();
//            if (source is not IEnumerable enumerable) throw new MappingException($"Source must be a collection to map to {typeof(IEnumerable<T>).Name}.");
//            return enumerable.Cast<object>().Select(item => Map<T>(item)).Where(result => result != null).ToList();
//        }
...
//        {
//            if (source == null) return new List<T>();
//            if (source is not IEnumerable enumerable) throw new MappingException($"Source must be a collection to map to {typeof(List<T>).Name}.");
//            return enumerable.Cast<object>().Select(item => Map<T>(item)).Where(result => result != null).ToList();
//        }
...
//        {
//            if (source == null) return new Dictionary<TKey, TValue>();
//            if (source is not IDictionary dictionary) throw new MappingException($"Source must be a dictionary to map to {typeof(Dictionary<TKey, TValue>).Name}.");
//            var result = new Dictionary<TKey, TValue>();
//            foreach (DictionaryEntry entry in dictionary)
//            {
//                if (entry.Key is TKey key && entry.Value != null)
...
//        public ImmutableList<T> MapImmutableList<T>(object? source) => MapIEnumerable<T>(source).ToImmutableList();
//        public ImmutableDictionary<TKey, TValue> MapImmutableDictionary<TKey, TValue>(object? source) where TKey : notnull => MapDictionary<TKey, TValue>(source).ToImmutableDictionary();
//        public ImmutableArray<T> MapImmutableArray<T>(object? source) => MapIEnumerable<T>(source).ToImmutableArray();
//        public ImmutableQueue<T> MapImmutableQueue<T>(object? source) => ImmutableQueue.CreateRange(MapIEnumerable<T>(source));
//        public ImmutableStack<T> MapImmutableStack<T>(object? source) => ImmutableStack.CreateRange(MapIEnumerable<T>(source));
...
//            var projectionBody = visitor.Visit();
//            var lambda = Expression.Lambda<Func<TSource, TDestination>>(projectionBody, parameter);
//            return source.Provider.CreateQuery<TDestination>(Expression.Call(typeof(Queryable), "Select", new Type[] { sourceType, targetType }, source.Expression, Expression.Quote(lambda)));
//        }
...
//                return default;
//            }
//            if (mappedObjects.TryGetValue(source, out var existing)) return (T)existing;
//            var sourceType = source.GetType();
//            var targetType = typeof(T);
...
//            var sourceType = typeof(TSource);
//            var targetType = typeof(TDestination);
//            var mapper = _compiledMappers.GetOrAdd((sourceType, targetType), key => BuildMapperDelegateWithDestination(key.Source, key.Target));
//            var result = ((Func<object, object, Dictionary<object, object>, object>)mapper)(source, destination, mappedObjects);
//            return (TDestination)result;
//        }
...
//            if (mappedObjects.TryGetValue(source, out var existing)) return existing;
//            var sourceType = source.GetType();
//            if (IsCollection(sourceType) && IsCollection(targetType)) return MapCollectionHelper(source as IEnumerable, targetType, mappedObjects);
//            var mapper = _compiledMappers.GetOrAdd((sourceType, targetType), key => BuildMapperDelegate(key.Source, key.Target));
...
//            var expressions = new List<Expression> { Expression.Assign(sourceVar, Expression.Convert(sourceParam, sourceType)) };

//            if (_config.CustomConstructors.TryGetValue((sourceType, targetType), out var customConstructor))
//            {
//                expressions.Add(Expression.Assign(resultVar, Expression.Convert(Expression.Invoke(Expression.Constant(customConstructor), Expression.Convert(sourceVar, typeof(object))), targetType)));
//            }
//            else if (_config.ConstructorSelection.TryGetValue((sourceType, targetType), out var parameterTypes))
//            {
//                var bestConstructor = targetType.GetConstructor(BindingFlags.Public | BindingFlags.Instance, null, parameterTypes, null);
...
//                    {
//                        var param = constructorParameters[i];
//                        var sourceProperty = sourceProperties.FirstOrDefault(sp => string.Equals(sp.Name, param.Name, StringComparison.OrdinalIgnoreCase));
//                        arguments[i] = sourceProperty != null ? Expression.Convert(Expression.Property(sourceVar, sourceProperty), param.ParameterType) : Expression.Default(param.ParameterType);
//                    }
//                    expressions.Add(Expression.Assign(resultVar, Expression.New(bestConstructor, arguments)));
//                }
//                else
...
//            else
//            {
//                expressions.Add(Expression.Assign(resultVar, Expression.Convert(Expression.Call(typeof(Activator).GetMethod(nameof(Activator.CreateInstance), new[] { typeof(Type) }), Expression.Constant(targetType)), targetType)));
//            }

//            expressions.Add(Expression.Assign(Expression.Property(mappedObjectsParam, "Item", sourceParam), Expression.Convert(resultVar, typeof(object))));

//            if (_config.BeforeMapActions.TryGetValue((sourceType, targetType), out var beforeActions))
//            {
//                foreach (var action in beforeActions)
//                {
//                    expressions.Add(Expression.Invoke(Expression.Constant(action), Expression.Convert(sourceVar, typeof(object)), Expression.Convert(resultVar, typeof(object))));
//                }
//            }

//            var convertValueMethod = typeof(MapperBase).GetMethod("ConvertValue", BindingFlags.Instance | BindingFlags.NonPublic);
//            var mapCollectionHelperMethod = typeof(JMSMapper).GetMethod("MapCollectionHelper", BindingFlags.Instance | BindingFlags.NonPublic);
//            var mapObjectMethod = typeof(JMSMapper).GetMethod("MapComplexType", BindingFlags.Instance | BindingFlags.NonPublic, new[] { typeof(Type), typeof(object), typeof(Dictionary<object, object>) });
//            var thisInstance = Expression.Constant(this);
//            var baseInstance = Expression.Convert(thisInstance, typeof(MapperBase));
...
//            {
//                if (!targetProperty.CanWrite) continue;
//                if (_config.IgnoredProperties.Contains((sourceType, targetType, targetProperty.Name))) continue;

//                Expression propertyMappingExpression = null;
//                var key = (sourceType, targetType);

//                if (_config.CustomMappings.TryGetValue(key, out var mappings) && mappings.TryGetValue(targetProperty.Name, out var mappingFunc))
//                {
//                    var valueExpression = Expression.Invoke(Expression.Constant(mappingFunc), Expression.Convert(sourceVar, typeof(object)));
//                    var convertedValueExpression = Expression.Call(baseInstance, convertValueMethod, valueExpression, Expression.Constant(targetProperty.PropertyType));
//                    propertyMappingExpression = Expression.Assign(Expression.Property(resultVar, targetProperty), Expression.Convert(convertedValueExpression, targetProperty.PropertyType));
//                }
//                else
//                {
//                    var sourcePropertyName = GetMappedPropertyName(sourceType, targetType, targetProperty.Name, _config.PropertyMappings, _config);
//                    var sourceProperty = sourceProperties.FirstOrDefault(p => string.Equals(p.Name, sourcePropertyName, StringComparison.OrdinalIgnoreCase));
...
//                    if (!sourceProperty.PropertyType.IsValueType || Nullable.GetUnderlyingType(sourceProperty.PropertyType) != null)
//                    {
//                        propertyMappingExpression = Expression.IfThen(Expression.NotEqual(sourcePropertyAccess, Expression.Constant(null, sourceProperty.PropertyType)), assignment);
//                    }
//                    else
//                    {
//                        propertyMappingExpression = assignment;
...
//            expressions.Add(Expression.Convert(resultVar, typeof(object)));
//            var body = Expression.Block(new[] { sourceVar, resultVar }, expressions);
//            var lambda = Expression.Lambda<Func<object, object, Dictionary<object, object>, object>>(body, sourceParam, destParam, mappedObjectsParam);
//            return lambda.Compile();
//        }
...
//            return !(type == typeof(string) || isSimpleValueType || IsCollection(type));
//        }

//        private string GetMappedPropertyName(Type sourceType, Type targetType, string targetPropertyName, Dictionary<(Type, Type), Dictionary<string, string>> propertyMappings, MapperConfiguration config)
//        {
//            var key = (sourceType, targetType);
//            if (propertyMappings.TryGetValue(key, out var mappings) && mappings.TryGetValue(targetPropertyName, out var sourcePropertyName)) return sourcePropertyName;
...
//            public ProjectionExpressionVisitor(MapperConfiguration config, Type sourceType, Type targetType, Expression sourceExpression, JMSMapper mapper, HashSet<(Type, Type)> visited)
//            {
//                _config = config;
//                _sourceType = sourceType;
//                _targetType = targetType;
...
//            public Expression Visit()
//            {
//                if (_visited.Contains((_sourceType, _targetType))) return Expression.Default(_targetType);
//                _visited.Add((_sourceType, _targetType));
//                var bindings = new List<MemberBinding>();
//                var targetProperties = _targetType.GetProperties(BindingFlags.Public | BindingFlags.Instance).Where(p => p.CanWrite);

//                foreach (var targetProperty in targetProperties)
//                {
//                    if (_config.IgnoredProperties.Contains((_sourceType, _targetType, targetProperty.Name))) continue;
...
//                    {
//                        var body = new ParameterReplacer(lambda.Parameters[0], (ParameterExpression)_sourceExpression).Visit(lambda.Body);
//                        bindings.Add(Expression.Bind(targetProperty, body));
//                        continue;
//                    }
...
//                    var sourceProperty = _sourceType.GetProperty(sourcePropertyName, BindingFlags.Public | BindingFlags.Instance | BindingFlags.IgnoreCase);
...
//                            var nestedInit = nestedVisitor.Visit();
//                            var nullCheck = Expression.Equal(sourcePropertyAccess, Expression.Constant(null, sourceProperty.PropertyType));
//                            var conditional = Expression.Condition(nullCheck, Expression.Default(targetProperty.PropertyType), nestedInit);
//                            bindings.Add(Expression.Bind(targetProperty, conditional));
//                        }
//                        else if (targetProperty.PropertyType.IsAssignableFrom(sourceProperty.PropertyType))
//                        {
...
//    {
//        public static void Validate(MapperConfiguration configuration)
//        {
//            var validator = new ConfigurationValidatorInternal(configuration);
//            validator.ValidateMappings();
//            validator.ValidateCircularReferences();
//            validator.ValidatePerformance();
//            validator.ThrowConfigurationExceptionsIfAny();
//        }

//        private class ConfigurationValidatorInternal
//        {
//            private readonly MapperConfiguration _configuration;
//            private readonly List<string> _warnings = new();
//            private readonly List<string> _errors = new();

//            public ConfigurationValidatorInternal(MapperConfiguration configuration) => _configuration = configuration;

//            public void ValidateMappings()
//            {
//                foreach (var typeMap in _configuration.CustomMappings.Keys.Concat(_configuration.PropertyMappings.Keys).Distinct())
//                {
//                    var sourceType = typeMap.Source;
//                    var targetType = typeMap.Target;
//                    var destProperties = targetType.GetProperties(BindingFlags.Public | BindingFlags.Instance).Where(p => p.CanWrite);
//                    var mappedProperties = new HashSet<string>();

//                    if (_configuration.CustomMappings.TryGetValue(typeMap, out var customMaps)) mappedProperties.UnionWith(customMaps.Keys);
//                    if (_configuration.PropertyMappings.TryGetValue(typeMap, out var propMaps)) mappedProperties.UnionWith(propMaps.Keys);
//                    if (_configuration.IgnoredProperties.Any(ip => ip.Source == sourceType && ip.Target == targetType)) mappedProperties.UnionWith(_configuration.IgnoredProperties.Where(ip => ip.Source == sourceType && ip.Target == targetType).Select(ip => ip.PropertyName));

//                    var unmapped = destProperties.Where(p => !mappedProperties.Contains(p.Name));
//                    if (unmapped.Any() && _configuration.ValidateMemberList == MemberListType.Destination)
//                    {
//                        _warnings.AddRange(unmapped.Select(p => $"Unmapped property: {sourceType.Name}.{p.Name} -> {targetType.Name}"));
//                    }
//                }
//            }

//            public void ValidateCircularReferences()
//            {
//                var visited = new HashSet<(Type, Type)>();
//                var stack = new Stack<(Type, Type)>();
...
//                    if (HasCircularReference(typeMap, visited, stack))
//                    {
//                        _errors.Add($"Circular reference detected involving {typeMap.Source.Name} -> {typeMap.Target.Name}");
//                    }
//                }
//            }

//            private bool HasCircularReference((Type Source, Type Target) current, HashSet<(Type, Type)> visited, Stack<(Type, Type)> stack)
//            {
//                if (stack.Contains(current)) return true;
//                if (visited.Contains(current)) return false;
//                visited.Add(current);
...
//                        {
//                            var elementTypePair = (elementType, current.Target);
//                            if (HasCircularReference(elementTypePair, visited, stack)) return true;
//                        }
//                    }
//                }
...
//            {
//                var totalMappings = _configuration.CustomMappings.Count + _configuration.PropertyMappings.Count;
//                var complexMappings = _configuration.CustomMappings.Values.Sum(cm => cm.Count) + _configuration.CustomMappingExpressions.Values.Sum(ce => ce.Count);
//                if (complexMappings > totalMappings * 0.3) _warnings.Add("High complexity detected - consider optimizing custom resolvers");
//            }

//            public void ThrowConfigurationExceptionsIfAny()
//            {
//                if (_errors.Any()) throw new MappingException($"Configuration errors:\n{string.Join("\n", _errors)}");
//                if (_warnings.Any()) Console.WriteLine($"Configuration warnings:\n{string.Join("\n", _warnings)}");
//            }
//        }
//    }
