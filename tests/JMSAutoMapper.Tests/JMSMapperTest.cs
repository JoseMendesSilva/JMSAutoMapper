...
public partial class JMSMapperTest
{
    ...
    public void Map_SimpleObject_ShouldMapCorrectly()
    {
        ...
        var source = new Cliente { Id = 1, RazaoSocial = "Test", Age = 25 };
    ...
    public void Map_IntToString_ShouldMapCorrectly()
    {
        // Arrange
        var mapper = new JMSMapper(new MapperConfiguration());
        var source = new Cliente { Id = 1, RazaoSocial = "123", Age = 25 };
        ...
        // Assert
        Assert.NotNull(result);
        Assert.Equal("123", result.RazaoSocial); // Verifica se o valor foi convertido corretamente para string
    }
    ...
    {
        // Arrange
        var origem = new Cliente { Id = 1, RazaoSocial = "Test", Age = 25 };
        ...
        Assert.Equal("Test", destino.RazaoSocial);
